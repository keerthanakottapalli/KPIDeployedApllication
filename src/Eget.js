...
const Sidebar = () => {
    ...
    const handleSubTabClick = async (subTab) => {
        ...
        if (token) {
            ...
            try {
                const response = await fetch(`${BASE_URL}/api/emp_userdata/${empId}/${activeTab}/${subTab}`);
                const data = await response.json();
    ...
    const handleSubTabUpdate = async () => {
        ...
        if (token) {
            ...
            try {
                ...
                const response = await fetch(`${BASE_URL}/api/emp_upd/${empId}/${activeTab}/${activeSubTab}`, {
                    method: 'PUT',
                    headers: {
                                    ...
                                    <Table>
                                        <TableHead>
                                            <TableRow style={{ backgroundColor: '#d0e6f5',  }}>
                                                ...
                                                <TableCell  style={{  fontWeight: "bold", fontFamily: 'Open Sans,sans-serif!important',textAlign:'center', fontSize:'16px' }}>Quantity Target</TableCell>
                                                <TableCell  style={{  fontWeight: "bold", fontFamily: 'Open Sans,sans-serif!important', textAlign:'center', fontSize:'16px'  }}>Quantity Achieved</TableCell>
                                                <TableCell  style={{  fontWeight: "bold", fontFamily: 'Open Sans,sans-serif!important',textAlign:'center', fontSize:'16px'  }}>Comments</TableCell>
                                                <TableCell  style={{  fontWeight: "bold", fontFamily: 'Open Sans,sans-serif!important', textAlign:'center', fontSize:'16px' }}>Index KPI</TableCell>
                                            </TableRow>
                                        </TableHead>
                                        <TableBody>
                                            {tabsData.map((item, index) => (
                                                <TableRow key={index}>
                                                    <TableCell style={{ }}>{item.Metric}</TableCell>
