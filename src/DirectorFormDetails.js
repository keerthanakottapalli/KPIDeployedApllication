    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            if (token) {
                ...
                try {
                    const response = await fetch(`${BASE_URL}/api/director_data/${empId}/${activeTab}`);
    ...
    const handleSubTabUpdate = async () => {
        ...
        if (token) {
            ...
            try {
                ...
                const response = await fetch(`${BASE_URL}/api/director_upd/${empId}/${activeTab}/${activeSubTab}`, {
                    method: 'PUT',
                    headers: {
...
export default DirectorFormDetails
