...
import { TextField, Tabs, Tab, Box, Table, TableBody, TableCell, Button, TableContainer, TableHead, TableRow, Paper, Select, MenuItem, ListItemIcon, Menu } from '@mui/material';
import './Tabs.css';
import {
...
const SubTabs = ({ subTabData, selectedTab, selectedSubTab, updateSelectedTabs, tabLabels, subTabsData }) => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            const response = await fetch(`${BASE_URL}/api/director_insrt`, {
                method: 'POST',
                headers: {
    ...
    useEffect(() => {
        ...
        const getApiUrl = `${BASE_URL}/save/director_data/${empId}`;
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            if (checkResponse.ok) {
                ...
                const updateApiUrl = `${BASE_URL}/save/director_upd/${empId}`;
                ...
                const postApiUrl = `${BASE_URL}/save/director_insrt`;
    ...
    const clearData = async () => {
        ...
        try {
            ...
            const deleteApiUrl = `${BASE_URL}/save/director_del/${empId}`;
...
const TabsView = () => {
    ...
    xhr.open("GET", `${BASE_URL}/admin/director_data`, false);
    xhr.send();
