...
const [incompleteFields, setIncompleteFields] = useState([]);
    ...
    const handleSubmit = async () => {
        ...
        try {
            const response = await fetch(`${BASE_URL}/api/manager_insrt`, {
                method: 'POST',
                headers: {
    ...
    useEffect(() => {
        ...
        const getApiUrl = `${BASE_URL}/save/manager_data/${empId}`;
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            if (checkResponse.ok) {
                ...
                const updateApiUrl = `${BASE_URL}/save/manager_upd/${empId}`;
                ...
                const postApiUrl = `${BASE_URL}/save/manager_insrt`;
    ...
    const clearData = async () => {
        ...
        try {
            ...
            const deleteApiUrl = `${BASE_URL}/save/manager_del/${empId}`;
